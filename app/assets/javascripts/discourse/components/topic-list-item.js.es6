...
export default Ember.Component.extend(StringBuffer, {
  ...
  createdDate: function(){
      return moment(this.get("topic.created_at")).format('LLLL');
  }.property("topic.created_at"),

    last_posted_date: function() {
        return moment(this.get("topic.last_posted_at")).format('LLLL');

    }.property("topic.last_posted_at"),
  lastPost: function(){
      return this.get('topic.posts');
  }.property("topic.posts"),
